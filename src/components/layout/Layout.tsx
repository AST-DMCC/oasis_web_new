...
//                 key={index}
//                 href={item.path}
//                 className="font-['Cairo',Helvetica] font-normal text-black text-sm lg:text-lg whitespace-nowrap"
//               >
//                 {item.title}
//               </Link>
//             ))}
...
//               variant="outline"
//               className="h-9 lg:h-11 px-6 rounded-[33px] border-2 border-[#562af5] font-['Josefin_Sans'] font-semibold text-[#562af5] text-sm lg:text-lg"
//             >
//               Log In
//             </Button>
//           </div>
...
//                               href={item.path}
//                               onClick={() => setMobileMenuOpen(false)}
//                               className="text-lg text-black font-['Cairo',Helvetica]"
//                             >
//                               {item.title}
//                             </Link>
//                           ))}
...
//                             onClick={navigateToLogin}
//                             variant="outline"
//                             className="h-11 w-full rounded-[33px] border-2 border-[#562af5] font-['Josefin_Sans'] font-semibold text-[#562af5] text-lg"
//                           >
//                             Log In
//                           </Button>
//                         </div>
