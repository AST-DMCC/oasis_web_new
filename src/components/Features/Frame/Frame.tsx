...
const features = [
  {
    ...
    items: [
      {  description: "• 23 modules aligned with the BACB 6th edition test content outline." },
      {  description: "• Pre-tests and post-tests assess your supervisees content knowledge per module." },
      {  description: "• Engaging lessons with built in knowledge checks throughout each module." },
    ],
  ...
  },
  {
    ...
    content: "Upload your work, receive feedback, and log your hours online—anywhere, anytime. Our platform provides:",
    items: [
      {  description: "• Supervisees can log hours with detailed information effortlessly." },
      {  description: "• Approve hours or ask for revision efficiently." },
      {  description: "• Visual representation of hours broken down into restricted and unrestricted hours, individual or group supervision hours, monthly hours and number of total hours." },
      // {  description: "• Compliance Management: Stay BACB-compliant with automated checks and reports." },
    ],
