...
export default function ArticleDetailPage({
  ...
  const handleDownloadPdf = async () => {
    ...
    try {
      ...
      pdf.save(`${safeTitle || "article-detail"}.pdf`);
    } catch (error) {
  ...
  return (
    <section className="w-full bg-[#f7f7f7] px-4 py-10 md:px-6 md:py-14">
      <div className="mx-auto w-full max-w-[1280px]">
        <div ref={pdfRef} className="rounded-[8px] bg-[#f7f7f7]">
                ...
                <div className="px-4 py-4">
                  ...
                  <div className="mt-4 space-y-3">
                    <button
                      ...
                      className="flex w-full items-center justify-between font-['Cairo',Helvetica] text-[13px] text-[#4b5563] transition hover:text-black disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      <span>
                        {isDownloading
                          ? "Downloading PDF..."
