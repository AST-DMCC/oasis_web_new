...
const manageModuleAccessData = {
  section: {
    title: "Managing Module Access",
    paragraphs: [
      "Administrators control which curriculum modules are available to each supervisee.",
      "From the supervisee’s profile, select Manage Module Access. Choose the modules you want to make available and save your changes. Module access updates take effect immediately and help ensure supervisees complete the appropriate learning sequence.",
    ],
