...
const editRemoveSuperviseeData = {
  ...
  section: {
    title: "Submitting Videos and Reviewing Feedback",
    paragraphs: [
      "Oasis allows you to submit supervision videos and receive detailed feedback from your supervisor.",
      "To upload a video, open the Video section and select New.Choose your file, add any relevant comments, and link the video to the appropriate module. Once uploaded, the video will be available for supervisor review.",
      "When feedback is provided, you can view it by opening Reviewed Videos and selecting the video title. Feedback appears as timestamped comments, allowing you to review specific moments and suggestions.",
    ],
