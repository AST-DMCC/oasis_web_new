...
const administratorResourcesData = {
  pageTitle: "Supervisee Resources",
  introSection: {
    iconBox: {
      bg: "bg-[#ece7f8]",
      icon: "/icons/p11.png",
    ...
    contentCard: {
      ...
      paragraphs: [
        "As a supervisee, Oasis helps you organize your learning, submit supervision materials, and track your fieldwork hours in one place.",
        "After logging in, you'll have access to curriculum modules, video submission tools, messaging, meetings, and time tracking. Your dashboard provides a clear overview of your progress and pending tasks.",
      ],
...
export const SuperviseeIntroSection = () => {
  return (
