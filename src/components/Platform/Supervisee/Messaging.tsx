...
const manageModuleAccessData = {
  section: {
    ...
    paragraphs: [
      "You can communicate with your supervisor directly through Oasis.",
      "The Messages feature allows you to send and receive messages without leaving the platform, keeping supervision communication organized and documented.",
      "The Meetings and Calendar features show upcoming supervision meetings. From here, you can view meeting details, join scheduled sessions, and keep track of your supervision schedule.",
    ],
