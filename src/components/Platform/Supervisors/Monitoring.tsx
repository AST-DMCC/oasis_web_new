...
const enrollSuperviseeData = {
  section: {
    title: "Moitoring Curriculum Progress",
    paragraphs: [
      "Supervisors can view supervisee progress across assigned modules.",
      "From the curriculum overview, you can see which modules have been started, completed, or require additional review. This helps you identify learning gaps and guide supervision sessions more effectively.",
    ],
